...
const defaultMeta = {
  title: 'Stubby - URL Shortener',
  siteName: 'Stubby - URL Shortener',
  description:
    'A simple URL shortener built with tRPC and Next.js.',
  /** Without additional '/' on the end, e.g. https://theodorusclarence.com */
  url: 'https://stubbyurl.vercel.app',
  type: 'website',
  robots: 'follow, index',
  /**
